...
namespace aaaSoft.Helpers
{
    public class UnitStringConverting
    {
        ...
        {
            Decimal TmpNumber = MinUnitNumber;
            for (int i = 0; i <= UnitsScaleList.Count - 1; i++)
            {
                Decimal tmpUnitConversion = UnitsScaleList[i];
        ...
        {
            Decimal tmpValue = MinUnitNumber;
        ...
        {
            int UnitIndex = GetFitUnitIndex(MinUnitNumber);
        ...
        public String GetString(Decimal MinUnitNumber, Int32 UnitIndex, Int32 NumberOfDecimalPlaces, Boolean SpaceBetweenNumberAndUnit)
        {
            ...
            Decimal unitUnits = GetUnits(MinUnitNumber, UnitIndex);
            String unitUnitsString = unitUnits.ToString("F" + NumberOfDecimalPlaces);
            String UnitString = UnitList[UnitIndex];
        ...
        {
            int MaxUnitIndex = UnitList.Count - 1;
            ...
            int MinUnitIndex = UnitList.IndexOf(MinUnit);
            if (MinUnitIndex < 0)
        ...
        public String GetString2(Decimal MinUnitNumber, Int32 MaxUnitIndex, Int32 MinUnitIndex, Boolean SpaceBetweenNumberAndUnit)
        {
            ...
            {
                Int32 CurrentUnitUnits = Decimal.ToInt32(GetUnits(TmpValue, i));
                String CurrentUnitUnitsString = CurrentUnitUnits.ToString();
                String UnitString = UnitList[i];
