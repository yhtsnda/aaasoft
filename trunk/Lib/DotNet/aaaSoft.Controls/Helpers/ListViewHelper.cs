...
namespace aaaSoft.Controls.Helpers
{
    /// <summary>
    ...
    public class ListViewColumnSorter : System.Collections.IComparer
    {
        ...
        public int Compare(object x, object y)
        {
            ...
            if (ColumnToSort <= listviewY.SubItems.Count - 1)
            ...
            if (IsIP(xText) && IsIP(yText))
            {
                ...
                //比较日期
            else if (DateTime.TryParse(xText, out xDateTime) && DateTime.TryParse(yText, out yDateTime))
            {
                compareResult = xDateTime.CompareTo(yDateTime);
            }
